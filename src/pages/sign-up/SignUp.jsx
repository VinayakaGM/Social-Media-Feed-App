...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-8 pt-8 mx-auto sm:pt-0 md:h-max lg:py-0">
      <div className="w-full bg-orange-200 border border-gray-300 rounded-lg shadow dark:border-stone-700 dark:bg-stone-700/40 md:mt-5 md:mb-5 sm:max-w-md xl:p-0">
